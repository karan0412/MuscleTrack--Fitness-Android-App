...
public final class FragmentAboutusBinding implements ViewBinding {
  ...
  public static FragmentAboutusBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.text_aboutus;
      TextView textAboutus = ViewBindings.findChildViewById(rootView, id);
      if (textAboutus == null) {
        break missingId;
      }

      return new FragmentAboutusBinding((ConstraintLayout) rootView, textAboutus);
    }
